...
class GUI:
    ...
    def initGUI(self):
        ...
        self.buttonShow = Button(self.frameSim, width=30, height=2,
                                 text='Show', command=self.drawModel)
        self.buttonShow.pack(side=TOP, padx=5, pady=5)
        self.showHelp(self.buttonShow, "Shows current status")
